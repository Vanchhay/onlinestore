                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="post_type">
                                    <option value="{{ "PRODUCT" }}" @if(isset($dataTypeContent->post_type) && $dataTypeContent->post_type == "PRODUCT"){{ 'selected="selected"' }}@endif>{{ "PRODUCT" }}</option>
                                    <option value="{{ "PROJECT" }}" @if(isset($dataTypeContent->post_type) && $dataTypeContent->post_type == "PROJECT"){{ 'selected="selected"' }}@endif>{{ "PROJECT" }}</option> 
                                </select>
                            </div>
